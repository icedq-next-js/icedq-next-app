...
export const metadata = {
  title: "Unified Data Testing, Monitoring &amp; Observability Platform",
  description: "Deliver data reliability with automated data testing, ETL testing, data migration testing, big data lake testing, data monitoring &amp; data observability.",
};
  ...
  return (
    <html lang="en">
      <head>
        <link
          rel="stylesheet"
          href="https://abyssgroupindia.com/wp-content/plugins/js_composer/assets/css/js_composer.min.css"
        />
      </head>
      ...
      >
        ...
        {children}
        <script src="https://abyssgroupindia.com/wp-includes/js/jquery/jquery.min.js"></script>
        <script src="https://abyssgroupindia.com/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min.js"></script>
      </body>
    </html>
  );
}
